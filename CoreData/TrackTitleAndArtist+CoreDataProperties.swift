//
//  TrackTitleAndArtist+CoreDataProperties.swift
//  Cataloger
//
...
extension UniqueTracks.TrackTitleAndArtists {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<UniqueTracks.TrackTitleAndArtists> {
...
extension UniqueTracks.TrackTitleAndArtists : Identifiable {
